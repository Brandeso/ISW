  ...
  <div class="container" style="margin-top:50px">
    ...
    <?php 
      ...
      if ($result->num_rows > 0) {
        echo "<table class='table table-dark'><thead><tr><th>ID Categoria</th><th>Nombre</th><th>Descripción</th></tr></thead><tbody>";
        // output data of each row
        while($row = $result->fetch_assoc()) {
          echo "<tr><td> ".$row["idCategoria"]." </td><td> ".$row["nombre"]." </td><td> ".$row["descripcion"]." </td></tr>";
        }
        echo "</tbody></table>";
      } else {
        echo "0 results";
